...
filename='./idl'+idlnumstring+'/temp-rz-'+idlnumstring+'.dat'
...
;set_plot, 'ps'
;device, xsize=33, ysize=15, file='./2d-by-xz-'+idlnumstring+'.eps', /color, /encapsulated

contour, log10te, x, z, nlevels=ncolors, xrange=[0.0, 60.0], yrange=[0.0, 4.0], zrange=[mincolor, maxcolor], position=[0.18, 0.18, 0.98, 0.98], xstyle=1, xtitle='x, [kpc]', ystyle=1, ytitle='z, [kpc]', /fill, charsize=1.5
...
contour,Vcolorbar, [0.0, 0.2], colorlevels, levels=colorlevels, position=[0.075, 0.18, 0.1, 0.48], xtickformat='(A1)', xstyle=7, xticks=0, xminor=0, ystyle=1, yticks=4, yminor=1, ytickv=[3, 4, 5, 6, 7], charsize=1.5, /fill, /noerase
