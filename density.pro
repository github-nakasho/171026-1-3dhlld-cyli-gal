...
;set_plot, 'ps'
;device, xsize=31, ysize=30, file='./densityeps/zplanerho-'+idlnumstring+'.eps', /color, /encapsulated

polar_contour, log10rho, phi, r, nlevels=ncolors, xrange=[-20.0, 20.0], yrange=[-20.0, 20.0], zrange=[mincolor, maxcolor], position=[0.2, 0.1, 0.98, 0.88], xstyle=1, xtitle='x, [kpc]', ystyle=1, ytitle='y, [kpc]', /fill, charsize=2.5
...
oplot, x3, y3, linestyle=2, color=16777215, thick=4
...
contour,Vcolorbar, [0.0, 0.2], colorlevels, levels=colorlevels, position=[0.075, 0.1, 0.1, 0.4], xtickformat='(A1)', xstyle=7, xticks=0, xminor=0, ystyle=1, yticks=3, yminor=1, ytickv=[-26, -25, -24, -23], charsize=2.5, /fill, /noerase
