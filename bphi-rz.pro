...
openr, lun, './idl135/r.txt', /get_lun
readf, lun, x

x=x*10


openr, lun, './idl135/z.txt', /get_lun
readf, lun, z
...
idlnum=0
for idlnum=135, 400 do begin


;-----change filename to output numbering-----

idlnumstring=string(idlnum, format='(i0)')
filename='./idl'+idlnumstring+'/bphi-rz-'+idlnumstring+'.dat'
...
for i=0, nx-1 do begin
	for j=0, nz-1 do begin
		...
		if bphi(i, j) le mincolor then bphi(i, j)=colorlevels(0)
endfor
endfor
...
contour, bphi, x, z, nlevels=ncolors, xrange=[0.0, 60.0], yrange=[0.0, 5.0], zrange=[mincolor, maxcolor], position=[0.18, 0.18, 0.98, 0.98], xstyle=1, xtitle='x, [kpc]', ystyle=1, ytitle='z, [kpc]', /fill, charsize=1.5
