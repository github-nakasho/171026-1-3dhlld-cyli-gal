...
openr, lun, './azimuth-2/phi.dat', /get_lun
readf, lun, phi
...
idlnumstring=string(idlnum, format='(i0)')
filename='./azimuth-2/rho-'+idlnumstring+'.dat'
...
idlnumstring=string(idlnum, format='(i0)')
filename='./azimuth-2/te-'+idlnumstring+'.dat'
...
idlnumstring=string(idlnum, format='(i0)')
filename='./azimuth-2/vperp-'+idlnumstring+'.dat'
...
idlnumstring=string(idlnum, format='(i0)')
filename='./azimuth-2/velocitypara-'+idlnumstring+'.dat'
