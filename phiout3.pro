...
openr, lun, './azimuth-3/phi.dat', /get_lun
readf, lun, phi
...
filename='./azimuth-3/potential-'+idlnumstring+'.dat'
...
idlnumstring=string(idlnum, format='(i0)')
filename='./azimuth-3/rho-'+idlnumstring+'.dat'
...
idlnumstring=string(idlnum, format='(i0)')
filename='./azimuth-3/te-'+idlnumstring+'.dat'
...
idlnumstring=string(idlnum, format='(i0)')
filename='./azimuth-3/vperp-'+idlnumstring+'.dat'
...
idlnumstring=string(idlnum, format='(i0)')
filename='./azimuth-3/velocitypara-'+idlnumstring+'.dat'
