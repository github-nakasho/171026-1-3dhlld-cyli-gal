...
filename='./idl'+idlnumstring+'/rho-rz-'+idlnumstring+'.dat'
...
for i=0, nx-1 do begin
	for j=0, nz-1 do begin
		...
		if log10rho(i, j) le mincolor then log10rho(i, j)=colorlevels(0)
endfor
endfor
...
contour, log10rho, x, z, nlevels=ncolors, xrange=[0.0, 60.0], yrange=[0.0, 5.0], zrange=[mincolor, maxcolor], position=[0.18, 0.18, 0.98, 0.98], xstyle=1, xtitle='x, [kpc]', ystyle=1, ytitle='z, [kpc]', /fill, charsize=1.5
